...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		*/
		...
		sparkReporter.config().setDocumentTitle("Lumen Automation Report"); // Title of report
		sparkReporter.config().setReportName("Lumen Functional Testing"); // name of the report
		sparkReporter.config().setTheme(Theme.DARK);
		
		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "Lumen");
	...
	public void onFinish(ITestContext testContext) {
		...
		sendEmail("purnima.sastry10@gmail.com","xyz123xyz","xyz@gmail.com");
	}
